...
//	// 회원정보수정 폼 검증
//	$('.edit-input-btn__save').click(function editCondition(isPwMatched, isNameDuplicate) {
//		  if (isPwMatched && !isNameDuplicate) {
//			  $('.edit-input-btn__save').prop("disabled", false);
//		  } else {
//		    if (!isPwMatched) {
//		    	$('.edit-input-btn__save').prop("disabled", true);
//		      alert("비밀번호를 확인해주세요");
//		    }
//		    if (isNameDuplicate) {
//		    	$('.edit-input-btn__save').prop("disabled", true);
...
//			},
//			error : function() {
//				$("#nameDuplicateCheck").text("서버와 통신하는 데 실패했습니다.");
//				isNameDuplicate = false;
//			}
//		});
//	}
