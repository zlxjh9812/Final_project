			...
			.ready(
					function() {
						...
						const input = document
								.querySelector('input[name=basic]');
						...
						<div class="member">
							<form action="login.do" method="post">
								...
								<div class="member-footer">
									<hr>
									<div>
										<a href="sign_up.jsp">회원가입</a> <a href="findId.do">아이디 찾기</a>
										<a href="updatePasswordGo.do">비밀번호 찾기</a>
									</div>
								</div>
							</form>
						</div>
		...
		<div class="container">
			...
			<form action="insertBoard.do" method="post"
				...
				<input type="hidden" id="nickname" name="nickname"
					value="${User.nickname }"> <input type="hidden" id="UserId"
