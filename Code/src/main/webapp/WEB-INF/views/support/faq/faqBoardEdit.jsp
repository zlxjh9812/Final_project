	...
	<div class="faq-write-container">
		<div class="faq-write-form-container">
			<div class="faq-write-main-title-wrap">
				<div class="faq-write-main-title">자주 묻는 질문 - 수정</div>
			</div>
		<form action="/support/faq/${board.boardId}/edit" method="post">
			...
			<div class="faq-write-content-container">
				...
				<div class="faq-write-content-wrap">
					...
					<div class="faq-content-edit-wrap">
						<textarea name="content" class="faq-edit-content-area"><c:out value="${board.content}" /></textarea>
					</div>
				</div>
				<div class="faq-form-write-btn-wrap">
					<button class="faq-btn faq-cancel-btn" type="button">취소</button>
					<button class="faq-btn faq-submit-btn" type="submit">수정하기</button>
				</div>
			</div>
		</form>
		</div>
