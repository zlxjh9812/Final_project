	...
	<div class="mypage-container">
		...
		<div class="mypage-content">
			<div class="mypage-edit-container">
				<div class="myfavorite-title">내가 평가한 컨텐츠</div>
				<div class="basic-info">
					...
					<form id="search-form" method="get" action="/mypage/mystar">
					...
					<div class="mycontents-container">
						...
						<ul class="mycontents-poster-list">
							<c:forEach items="${detailList}" var="detail" varStatus="status">
								...
								<div><i class="fa-solid fa-star mycontents-star"></i>${myContentsList[status.index].getStar()}</div>
								</li>
							</c:forEach>
						</ul>
					</div>
