...
<table class="table" >
  ...
  <thead>
    ...
    <tr class = "table-secondary">
      ...
      <th scope="col">신고된 날짜</th>
      <th scope="col">정지 해제 날짜</th>
       <th scope="col">해제 하기 <input type = "checkbox" name = "checkAll" id = "check_all"></th>
 
    </tr>
  </thead>
  <tbody>
  	<c:forEach items = "${EndDate }" var = "list">
    <tr>
      ...
      <td  >${list.endDate }</td>
      <td><input type = "checkbox" value = "${list.userId }" name = "UserId" class = "UserId"></td>
    </tr>
...
<form id='pageForm' action="getEndDateBlackListUser.do" method='get'>
