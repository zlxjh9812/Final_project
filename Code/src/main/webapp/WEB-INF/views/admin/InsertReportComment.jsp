...
<div id = "reportWrap">
	<form id="fmReport" name="fmReport" action="insertCommentReport.do" onsubmit="submitReport(); return false;">
<div class="hiddenFields">
<input type="hidden" name="seq" value="${report.seq }">
<input type="hidden" name="tableNum" value="${report.tableNum }">
...
<input type="hidden" name="targetID" value="${report.targetID }">
	...
	<div id="reportsBody">
		<dl>
			<dt>내용</dt>
			<dd><span>${comment }</span></dd>
		</dl>
        		<dl>
			<dt>작성자 아이디</dt>
			<dd><span>${report.targetID }</span></dd>
		</dl>
        		<dl>
			<dt>신고자 아이디</dt>
			<dd><span>${report.userId }</span></dd>
		</dl>
		<dl>
			<dt>신고사유</dt>
			<dd>
